...
import { u as useRedirect, S as SigninContainer } from '../../../dist/useFromRedirect-25dcf5de.esm.js';
...
const SigninPage = _ref => {
  ...
  useEffect(() => {
    var _rawKeystone$adminMet, _rawKeystone$adminMet2;
    if (!submitted) return;

    // TODO: this is horrible, we need to resolve this mess
    // @ts-ignore
    if (((_rawKeystone$adminMet = rawKeystone.adminMeta) === null || _rawKeystone$adminMet === void 0 ? void 0 : (_rawKeystone$adminMet2 = _rawKeystone$adminMet.error) === null || _rawKeystone$adminMet2 === void 0 ? void 0 : _rawKeystone$adminMet2.message) === 'Access denied') {
  ...
  return jsx(SigninContainer, {
    ...
    title: "Error",
    tone: "negative"
  }, error.message), (data === null || data === void 0 ? void 0 : (_data$authenticate2 = data.authenticate) === null || _data$authenticate2 === void 0 ? void 0 : _data$authenticate2.__typename) === failureTypename && jsx(Notice, {
    title: "Error",
    tone: "negative"
    ...
    (data === null || data === void 0 ? void 0 : (_data$authenticate3 = data.authenticate) === null || _data$authenticate3 === void 0 ? void 0 : _data$authenticate3.__typename) === successTypename,
    type: "submit"
  }, "Sign in"))));
};
