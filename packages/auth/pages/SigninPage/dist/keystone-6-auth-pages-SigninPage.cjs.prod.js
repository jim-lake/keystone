...
var useFromRedirect = require('../../../dist/useFromRedirect-88dbe1df.cjs.prod.js');
...
const SigninPage = _ref => {
  ...
  return core.jsx(useFromRedirect.SigninContainer, {
    ...
    title: "Error",
    tone: "negative"
  }, error.message), (data === null || data === void 0 ? void 0 : (_data$authenticate2 = data.authenticate) === null || _data$authenticate2 === void 0 ? void 0 : _data$authenticate2.__typename) === failureTypename && core.jsx(notice.Notice, {
    title: "Error",
    tone: "negative"
