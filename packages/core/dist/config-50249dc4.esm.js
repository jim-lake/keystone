import { GraphQLScalarType, GraphQLObjectType, Kind, OperationTypeNode, GraphQLSchema, execute, astFromValue, GraphQLNonNull, GraphQLList, assertInputObjectType, isInputObjectType, GraphQLString } from 'graphql';
import { Q as QueryMode, f as fieldType, o as orderDirectionEnum } from './next-fields-34f831a7.esm.js';
...
import { h as humanize, p as prismaError, u as userInputError, e as extensionError, b as accessReturnError, f as filterAccessError, l as limitsExceededError } from './graphql-errors-473725b1.esm.js';
import pluralize from 'pluralize';
import { g as getGqlNames } from './utils-8175c66a.esm.js';
import { maybeCacheControlFromInfo } from '@apollo/cache-control-types';
import DataLoader from 'dataloader';
import { ID, inputObject, arg, list, nonNull, Int, Boolean } from '@graphql-ts/schema/api-without-context';
...
async function resolveUniqueWhereInput(input, list, context) {
  ...
  if (inputKeys.length !== 1) {
    throw userInputError(`Exactly one key must be passed in a unique where input but ${inputKeys.length} keys were passed`);
  }
...
function parseListAccessControl(access) {
  ...
  return {
    operation: {
      query: (_operation$query = operation.query) !== null && _operation$query !== void 0 ? _operation$query : allowAll,
      create: (_operation$create = operation.create) !== null && _operation$create !== void 0 ? _operation$create : allowAll,
      update: (_operation$update = operation.update) !== null && _operation$update !== void 0 ? _operation$update : allowAll,
      delete: (_operation$delete = operation.delete) !== null && _operation$delete !== void 0 ? _operation$delete : allowAll
    },
    filter: {
...
async function findMany(_ref2, list, context, info, extraFilter) {
  ...
  if (list.cacheHint) {
    ...
    (_maybeCacheControlFro = maybeCacheControlFromInfo(info)) === null || _maybeCacheControlFro === void 0 ? void 0 : _maybeCacheControlFro.setCacheHint(list.cacheHint({
      results,
...
async function count(_ref3, list, context, info, extraFilter) {
  ...
  if (list.cacheHint) {
    ...
    (_maybeCacheControlFro2 = maybeCacheControlFromInfo(info)) === null || _maybeCacheControlFro2 === void 0 ? void 0 : _maybeCacheControlFro2.setCacheHint(list.cacheHint({
      results: count,
  ...
  return field({
    ...
    async resolve(rootVal, args, context, info) {
      ...
      if (cacheHint && info) {
        ...
        (_maybeCacheControlFro = maybeCacheControlFromInfo(info)) === null || _maybeCacheControlFro === void 0 ? void 0 : _maybeCacheControlFro.setCacheHint(cacheHint);
      }
  ...
  for (const [listKey, list] of Object.entries(lists)) {
    ...
    for (const fieldKey of Object.keys(list.fields)) {
      ...
      if ((fieldFilterFields === null || fieldFilterFields === void 0 ? void 0 : (_fieldFilterFields$co = fieldFilterFields.contains) === null || _fieldFilterFields$co === void 0 ? void 0 : _fieldFilterFields$co.type) === GraphQLString) {
        ...
        searchableFields.set(fieldKey, (fieldFilterFields === null || fieldFilterFields === void 0 ? void 0 : (_fieldFilterFields$mo = fieldFilterFields.mode) === null || _fieldFilterFields$mo === void 0 ? void 0 : _fieldFilterFields$mo.type) === QueryMode.graphQLType ? 'insensitive' : 'default');
      }
    }
...
function getListGraphqlTypes(listsConfig, lists, intermediateLists) {
  ...
  for (const [listKey, listConfig] of Object.entries(listsConfig)) {
    ...
    const findManyArgs = {
      ...
      orderBy: arg({
        type: nonNull(list(nonNull(orderBy))),
        defaultValue: []
      }),
      take,
      skip: arg({
    ...
    if (isEnabled.type) {
      relateToManyForCreate = inputObject({
        ...
        fields: () => {
          return {
            ...
            ...(isEnabled.create && {
              create: arg({
                type: list(nonNull(create))
              })
            }),
            connect: arg({
              type: list(nonNull(uniqueWhere))
            })
          };
        }
      });
      relateToManyForUpdate = inputObject({
      ...
      relateToOneForCreate = inputObject({
      ...
      relateToOneForUpdate = inputObject({
...
export { runWithPrisma as a, cannotForItemFields as b, cannotForItem as c, resolveUniqueWhereInput as d, isRejected as e, isFulfilled as f, getOperationAccess as g, getAccessFilters as h, initConfig as i, getWriteLimit as j, checkFilterOrderAccess as k, getDBFieldKeyForFieldOnMultiField as l, mapUniqueWhereToWhere as m, getPrismaNamespace as n, findOne as o, promiseAllRejectWithAllErrors as p, findMany as q, resolveWhereInput as r, count as s, getVariablesForGraphQLField as t, executeGraphQLFieldToRootVal as u, initialiseLists as v, setWriteLimit as w, setPrismaNamespace as x, areArraysEqual as y };
