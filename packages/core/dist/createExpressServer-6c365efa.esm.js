...
const createExpressServer = async (config, graphQLSchema, context) => {
  ...
  const serverConfig = {
    ...
    plugins: playgroundOption === 'apollo' ? apolloConfig === null || apolloConfig === void 0 ? void 0 : apolloConfig.plugins : [playgroundOption ? ApolloServerPluginLandingPageLocalDefault() : ApolloServerPluginLandingPageDisabled(), ...((apolloConfig === null || apolloConfig === void 0 ? void 0 : apolloConfig.plugins) || [])]
  };
  ...
  expressServer.use(((_config$graphql4 = config.graphql) === null || _config$graphql4 === void 0 ? void 0 : _config$graphql4.path) || '/api/graphql', json((_config$graphql5 = config.graphql) === null || _config$graphql5 === void 0 ? void 0 : _config$graphql5.bodyParser), expressMiddleware(apolloServer, {
    context: async _ref => {
      let {
        req,
        res
...
export { createExpressServer as a, createAdminUIMiddlewareWithNextApp as c, healthCheckPath as h, pkgDir as p, telemetryEndpoint as t };
