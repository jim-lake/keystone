...
var nextFields = require('./next-fields-f1c33a35.cjs.prod.js');
var graphqlTsSchema = require('./graphql-ts-schema-e1666bd5.cjs.prod.js');
var values = require('graphql/execution/values');
var access_dist_keystone6CoreAccess = require('../access/dist/keystone-6-core-access.cjs.prod.js');
var graphqlErrors = require('./graphql-errors-e0d981de.cjs.prod.js');
var pluralize = require('pluralize');
var utils = require('./utils-7d247517.cjs.prod.js');
...
function parseFieldAccessControl(access) {
  ...
  return {
    read: (_access$read = access === null || access === void 0 ? void 0 : access.read) !== null && _access$read !== void 0 ? _access$read : access_dist_keystone6CoreAccess.allowAll,
    create: (_access$create = access === null || access === void 0 ? void 0 : access.create) !== null && _access$create !== void 0 ? _access$create : access_dist_keystone6CoreAccess.allowAll,
    update: (_access$update = access === null || access === void 0 ? void 0 : access.update) !== null && _access$update !== void 0 ? _access$update : access_dist_keystone6CoreAccess.allowAll
  };
}
function parseListAccessControl(access) {
  ...
  if (typeof access === 'function') {
    return {
      ...
      filter: {
        query: access_dist_keystone6CoreAccess.allowAll,
        update: access_dist_keystone6CoreAccess.allowAll,
        delete: access_dist_keystone6CoreAccess.allowAll
      },
      item: {
        create: access_dist_keystone6CoreAccess.allowAll,
        update: access_dist_keystone6CoreAccess.allowAll,
        delete: access_dist_keystone6CoreAccess.allowAll
      }
    };
  ...
  return {
    operation: {
      query: (_operation$query = operation.query) !== null && _operation$query !== void 0 ? _operation$query : access_dist_keystone6CoreAccess.allowAll,
      create: (_operation$create = operation.create) !== null && _operation$create !== void 0 ? _operation$create : access_dist_keystone6CoreAccess.allowAll,
      update: (_operation$update = operation.update) !== null && _operation$update !== void 0 ? _operation$update : access_dist_keystone6CoreAccess.allowAll,
      delete: (_operation$delete = operation.delete) !== null && _operation$delete !== void 0 ? _operation$delete : access_dist_keystone6CoreAccess.allowAll
    },
    filter: {
      query: (_filter$query = filter === null || filter === void 0 ? void 0 : filter.query) !== null && _filter$query !== void 0 ? _filter$query : access_dist_keystone6CoreAccess.allowAll,
      // create: not supported
      update: (_filter$update = filter === null || filter === void 0 ? void 0 : filter.update) !== null && _filter$update !== void 0 ? _filter$update : access_dist_keystone6CoreAccess.allowAll,
      delete: (_filter$delete = filter === null || filter === void 0 ? void 0 : filter.delete) !== null && _filter$delete !== void 0 ? _filter$delete : access_dist_keystone6CoreAccess.allowAll
    },
    item: {
      // query: not supported
      create: (_item$create = item === null || item === void 0 ? void 0 : item.create) !== null && _item$create !== void 0 ? _item$create : access_dist_keystone6CoreAccess.allowAll,
      update: (_item$update = item === null || item === void 0 ? void 0 : item.update) !== null && _item$update !== void 0 ? _item$update : access_dist_keystone6CoreAccess.allowAll,
      delete: (_item$delete = item === null || item === void 0 ? void 0 : item.delete) !== null && _item$delete !== void 0 ? _item$delete : access_dist_keystone6CoreAccess.allowAll
    }
  };
}
...
async function findMany(_ref2, list, context, info, extraFilter) {
  ...
  if (list.cacheHint) {
    ...
    (_maybeCacheControlFro = cacheControlTypes.maybeCacheControlFromInfo(info)) === null || _maybeCacheControlFro === void 0 ? void 0 : _maybeCacheControlFro.setCacheHint(list.cacheHint({
      results,
...
async function resolveOrderBy(orderBy, list, context) {
  ...
  orderBy.forEach(orderBySelection => {
    ...
    if (keys.length !== 1) {
      throw graphqlErrors.userInputError(`Only a single key must be passed to ${list.graphql.types.orderBy.graphQLType.name}`);
    }
...
async function count(_ref3, list, context, info, extraFilter) {
  ...
  if (list.cacheHint) {
    ...
    (_maybeCacheControlFro2 = cacheControlTypes.maybeCacheControlFromInfo(info)) === null || _maybeCacheControlFro2 === void 0 ? void 0 : _maybeCacheControlFro2.setCacheHint(list.cacheHint({
      results: count,
  ...
  return graphqlTsSchema.field({
    ...
    async resolve(rootVal, args, context, info) {
      ...
      if (cacheHint && info) {
        ...
        (_maybeCacheControlFro = cacheControlTypes.maybeCacheControlFromInfo(info)) === null || _maybeCacheControlFro === void 0 ? void 0 : _maybeCacheControlFro.setCacheHint(cacheHint);
      }
...
function assertFieldsIsNonNullAllowed(list) {
  for (const [fieldKey, field] of Object.entries(list.fields)) {
    if (field.access.read !== access_dist_keystone6CoreAccess.allowAll) {
...
function getIsEnabled(listsConfig) {
  ...
  for (const [listKey, listConfig] of Object.entries(listsConfig)) {
    ...
    if (omit === true) {
      ...
      isEnabled[listKey] = {
        type: true,
        query: !(omit !== null && omit !== void 0 && omit.query),
        create: !(omit !== null && omit !== void 0 && omit.create),
        update: !(omit !== null && omit !== void 0 && omit.update),
        delete: !(omit !== null && omit !== void 0 && omit.delete),
...
function defaultListHooksResolveInput(_ref) {
  let {
    resolvedData
  } = _ref;
  return resolvedData;
...
function parseListHooksResolveInput(f) {
  ...
  return {
    create: create !== null && create !== void 0 ? create : defaultListHooksResolveInput,
    update: update !== null && update !== void 0 ? update : defaultListHooksResolveInput
  };
}
...
function defaultFieldHooksResolveInput(_ref2) {
  let {
    resolvedData,
    fieldKey
  } = _ref2;
...
function parseFieldHooksResolveInput(f) {
  return f !== null && f !== void 0 ? f : defaultFieldHooksResolveInput;
  // TODO: one day
  //    if (typeof f === 'function') {
  //      return {
  //        create: f,
...
function getListsWithInitialisedFields(_ref3, listGraphqlTypes, intermediateLists) {
  let {
  ...
  for (const [listKey, list] of Object.entries(listsConfig)) {
    var _list$ui$labelField, _list$ui, _list$ui$searchFields, _list$ui2, _list$db, _list$db2, _list$hooks, _list$isSingleton;
    ...
    for (const [idx, [fieldKey, fieldFunc]] of Object.entries(list.fields).entries()) {
      var _f$graphql, _f$isFilterable, _f$isOrderable, _f$hooks, _f$graphql2, _f$graphql$isNonNull$, _f$graphql3, _f$graphql3$isNonNull, _f$graphql$isNonNull$2, _f$graphql4, _f$graphql4$isNonNull, _f$graphql$isNonNull$3, _f$graphql5, _f$graphql5$isNonNull;
      ...
      const read = omit !== true && !(omit !== null && omit !== void 0 && omit.read);
      const _isEnabled = {
        read,
        create: omit !== true && !(omit !== null && omit !== void 0 && omit.create),
        update: omit !== true && !(omit !== null && omit !== void 0 && omit.update),
      ...
      resultFields[fieldKey] = {
        ...
        graphql: {
          ...
          isNonNull: {
            read: (_f$graphql$isNonNull$ = (_f$graphql3 = f.graphql) === null || _f$graphql3 === void 0 ? void 0 : (_f$graphql3$isNonNull = _f$graphql3.isNonNull) === null || _f$graphql3$isNonNull === void 0 ? void 0 : _f$graphql3$isNonNull.read) !== null && _f$graphql$isNonNull$ !== void 0 ? _f$graphql$isNonNull$ : false,
            create: (_f$graphql$isNonNull$2 = (_f$graphql4 = f.graphql) === null || _f$graphql4 === void 0 ? void 0 : (_f$graphql4$isNonNull = _f$graphql4.isNonNull) === null || _f$graphql4$isNonNull === void 0 ? void 0 : _f$graphql4$isNonNull.create) !== null && _f$graphql$isNonNull$2 !== void 0 ? _f$graphql$isNonNull$2 : false,
            update: (_f$graphql$isNonNull$3 = (_f$graphql5 = f.graphql) === null || _f$graphql5 === void 0 ? void 0 : (_f$graphql5$isNonNull = _f$graphql5.isNonNull) === null || _f$graphql5$isNonNull === void 0 ? void 0 : _f$graphql5$isNonNull.update) !== null && _f$graphql$isNonNull$3 !== void 0 ? _f$graphql$isNonNull$3 : false
          }
        },
        input: {
          ...f.input
    ...
    result[listKey] = {
      ...
      prisma: {
        ...
        mapping: (_list$db = list.db) === null || _list$db === void 0 ? void 0 : _list$db.map,
        extendPrismaSchema: (_list$db2 = list.db) === null || _list$db2 === void 0 ? void 0 : _list$db2.extendPrismaSchema
      },
      ui: {
      ...
      hooks: parseListHooks((_list$hooks = list.hooks) !== null && _list$hooks !== void 0 ? _list$hooks : {}),
      listKey,
      cacheHint: (() => {
        var _list$graphql;
...
function graphqlArgForInputField(field, operation) {
  var _field$input;
  const input = (_field$input = field.input) === null || _field$input === void 0 ? void 0 : _field$input[operation];
  ...
  return apiWithoutContext.arg({
    ...input.arg,
    type: apiWithoutContext.nonNull(input.arg.type)
  });
}
function graphqlForOutputField(field) {
  ...
  return graphqlTsSchema.field({
    ...output,
    type: apiWithoutContext.nonNull(output.type)
  });
}
  ...
  for (const [listKey, listConfig] of Object.entries(listsConfig)) {
    ...
    const output = apiWithContext.object()({
      ...
      fields: () => {
        ...
        return {
          ...Object.fromEntries(Object.entries(fields).flatMap(_ref4 => {
            let [fieldPath, field] = _ref4;
            ...
            return [[fieldPath, outputFieldRoot], ...Object.entries(field.extraOutputFields || {})].map(_ref5 => {
              var _field$graphql;
              let [outputTypeFieldName, outputField] = _ref5;
    ...
    const uniqueWhere = apiWithoutContext.inputObject({
      ...
      fields: () => {
        ...
        return {
          ...Object.fromEntries(Object.entries(fields).flatMap(_ref6 => {
            var _field$input2, _field$input2$uniqueW;
            let [key, field] = _ref6;
            if (!((_field$input2 = field.input) !== null && _field$input2 !== void 0 && (_field$input2$uniqueW = _field$input2.uniqueWhere) !== null && _field$input2$uniqueW !== void 0 && _field$input2$uniqueW.arg) || !field.graphql.isEnabled.read || !field.graphql.isEnabled.filter) {
              return [];
            }
    ...
    const where = apiWithoutContext.inputObject({
      ...
      fields: () => {
        ...
        }, ...Object.entries(fields).map(_ref7 => {
          var _field$input3, _field$input3$where, _field$input4, _field$input4$where;
          let [fieldKey, field] = _ref7;
          return ((_field$input3 = field.input) === null || _field$input3 === void 0 ? void 0 : (_field$input3$where = _field$input3.where) === null || _field$input3$where === void 0 ? void 0 : _field$input3$where.arg) && field.graphql.isEnabled.read && field.graphql.isEnabled.filter && {
            [fieldKey]: (_field$input4 = field.input) === null || _field$input4 === void 0 ? void 0 : (_field$input4$where = _field$input4.where) === null || _field$input4$where === void 0 ? void 0 : _field$input4$where.arg
          };
        }));
      }
    });
    ...
    const orderBy = apiWithoutContext.inputObject({
      ...
      fields: () => {
        ...
        return Object.fromEntries(Object.entries(fields).flatMap(_ref8 => {
          var _field$input5, _field$input5$orderBy;
          let [key, field] = _ref8;
          if (!((_field$input5 = field.input) !== null && _field$input5 !== void 0 && (_field$input5$orderBy = _field$input5.orderBy) !== null && _field$input5$orderBy !== void 0 && _field$input5$orderBy.arg) || !field.graphql.isEnabled.read || !field.graphql.isEnabled.orderBy) {
            return [];
          }
...
function initialiseLists(config) {
  ...
  for (const list of Object.values(intermediateLists)) {
    ...
    for (const field of Object.values(list.fields)) {
      var _field$input6, _field$input6$create, _field$input7;
      if ((_field$input6 = field.input) !== null && _field$input6 !== void 0 && (_field$input6$create = _field$input6.create) !== null && _field$input6$create !== void 0 && _field$input6$create.arg && field.graphql.isEnabled.create) {
...
function applyIdFieldDefaults(config) {
  ...
  const defaultIdField = getIdField((_config$db$idField = config.db.idField) !== null && _config$db$idField !== void 0 ? _config$db$idField : {
    kind: 'cuid'
  });
  ...
  for (const [listKey, list] of Object.entries(config.lists)) {
    var _list$db, _list$db$idField, _list$db2;
    if (list.fields.id) {
      throw new Error(`A field with the \`id\` path is defined in the fields object on the ${JSON.stringify(listKey)} list. This is not allowed, use the idField option instead.`);
    }
    if (((_list$db = list.db) === null || _list$db === void 0 ? void 0 : (_list$db$idField = _list$db.idField) === null || _list$db$idField === void 0 ? void 0 : _list$db$idField.kind) === 'autoincrement' && list.db.idField.type === 'BigInt' && config.db.provider === 'sqlite') {
      throw new Error(`BigInt autoincrements are not supported on SQLite but they are configured at db.idField on the ${listKey} list`);
    }
    if (list.isSingleton && (_list$db2 = list.db) !== null && _list$db2 !== void 0 && _list$db2.idField) {
      throw new Error(`A singleton list cannot specify an idField, but it is configured at db.idField on the ${listKey} list`);
    }
  }
  ...
  const listsWithIds = {};
  for (const [listKey, list] of Object.entries(config.lists)) {
    var _list$db$idField2, _list$db3;
    if (list.isSingleton) {
    ...
    listsWithIds[listKey] = {
      ...list,
      fields: {
        id: idFieldType(getIdField((_list$db$idField2 = (_list$db3 = list.db) === null || _list$db3 === void 0 ? void 0 : _list$db3.idField) !== null && _list$db$idField2 !== void 0 ? _list$db$idField2 : defaultIdField), false),
        ...list.fields
      }
    };
  }
