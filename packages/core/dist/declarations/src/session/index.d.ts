...
export declare function statelessSessions<Session>({ secret, maxAge, cookieName, path, secure, ironOptions, domain, sameSite, }: StatelessSessionsOptions): SessionStrategy<Session, any>;
/** @deprecated */
export declare function storedSessions<Session>({ store: storeFn, maxAge, ...statelessSessionsOptions }: {
