...
export type FieldViews = Record<string, {
...
export type CellComponent<FieldControllerFn extends (...args: any) => FieldController<any, any> = () => FieldController<any, any>> = {
    (props: {
...
export type CardValueComponent<FieldControllerFn extends (...args: any) => FieldController<any, any> = () => FieldController<any, any>> = (props: {
    item: Record<string, any>;
    field: ReturnType<FieldControllerFn>;
}) => ReactElement;
export {};
//# sourceMappingURL=admin-meta.d.ts.map