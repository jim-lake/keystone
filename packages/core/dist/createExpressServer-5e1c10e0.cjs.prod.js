...
const createExpressServer = async (config, graphQLSchema, context) => {
  ...
  const playgroundOption = (_config$graphql$playg = (_config$graphql2 = config.graphql) === null || _config$graphql2 === void 0 ? void 0 : _config$graphql2.playground) !== null && _config$graphql$playg !== void 0 ? _config$graphql$playg :         "production" !== 'production';
  const serverConfig = {
