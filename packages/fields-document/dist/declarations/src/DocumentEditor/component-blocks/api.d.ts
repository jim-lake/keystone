...
export type FormFieldWithGraphQLField<Value extends FormFieldValue, Options> = FormField<Value, Options> & {
    graphql: {
...
export type ConditionalField<DiscriminantField extends FormField<string | boolean, any>, ConditionalValues extends {
...
export type ComponentSchema = ChildField | FormField<any, any> | ObjectField | ConditionalField<FormField<any, any>, {
...
export type ComponentSchemaForGraphQL = FormFieldWithGraphQLField<any, any> | ObjectField<Record<string, ComponentSchemaForGraphQL>> | ConditionalField<FormFieldWithGraphQLField<any, any>, {
...
export declare const fields: {
    ...
    array<ElementField extends ComponentSchema>(element: ElementField, opts?: {
        itemLabel?: ((props: GenericPreviewProps<ElementField, unknown>) => string) | undefined;
...
type ConditionalFieldPreviewProps<Schema extends ConditionalField<FormField<string | boolean, any>, any>, ChildFieldElement> = {
...
type DiscriminantStringToDiscriminantValue<DiscriminantField extends FormField<any, any>, DiscriminantString extends PropertyKey> = DiscriminantField['defaultValue'] extends boolean ? 'true' extends DiscriminantString ? true : 'false' extends DiscriminantString ? false : never : DiscriminantString;
