...
} & Omit<import("react").PropsWithoutRef<import("react").ComponentProps<Comp>>, "color" | "as" | "weight" | "size" | keyof import("./Box").ColorProps | keyof import("./Box").RadiiProps | keyof import("./Box").MarginProps | keyof import("./Box").PaddingProps | keyof {
