...
export declare const SegmentedControl: ({ animate, fill, onChange, segments, isDisabled, isReadOnly, size, width, selectedIndex, ...props }: SegmentedControlProps) => jsx.JSX.Element;
export {};
