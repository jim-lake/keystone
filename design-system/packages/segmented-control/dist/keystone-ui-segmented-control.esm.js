...
import { useTheme, useId, jsx, Box, VisuallyHidden } from '@keystone-ui/core';
...
const SegmentedControl = _ref => {
  ...
  return jsx(Box, _extends({
    ...
    as: "label"
  }, "None Selected", jsx(VisuallyHidden, {
    as: "input",
    type: "radio",
    onChange: () => {},
    ...
    value: "none"
  })), animate && selectedIndex > -1 ? jsx(SelectedIndicator, {
    size: size,
    style: selectedRect
  }) : null));
};
...
// Styled Components
// ------------------------------
const Root = /*#__PURE__*/forwardRef((_ref2, ref) => {
  let {
    fill,
    size,
    width,
